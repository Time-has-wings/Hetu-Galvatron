...
# class FFNTimeCostModel(TimeCostModelBase):
...
# class FFNMemoryCostModel(MemoryCostModelBase):
#     pass


# # =============================MoE FFN Cost Model============================================
# # moe_ffn_time_args_list = {
# #     'TrainArgs': ['seq_length', 'hidden_size', 'mixed_precision', 'num_experts', 'top_k', 'moe_grouped_gemm'],
# #     'ProfileModelArgs': ['forward_computation_time', 'parameter_memory'],
# #     'ProfileHardwareArgs': ['bct_fct_coe', 'overlap_slowdown_coe', 'comm_coe_dict', 'p2p_comm_coe_dict', 'allreduce_fit_dict', 'all2all_fit_dict', 'allreduce_fixed_dict'],
# #     'UtilsArgs': ['extra_overhead', 'costmodel_coe', 'dummy_layer_num'],
# #     'VersionOptionArgs': ['estimate_tp_time_type'],
# # }

# # moe_ffn_memory_args_list = {
# #         'TrainArgs': ['seq_length', 'hidden_size', 'mixed_precision', 'async_grad_reduce', 'use_zero2_for_dp', 'sequence_parallel', 'pipeline_type', 'num_experts', 'top_k', 'moe_grouped_gemm'],
# #         'ProfileModelArgs': ['parameter_memory', 'tp_activation_per_bsz_dict' ],
# #         'VersionOptionArgs': ['zero_with_slight_noise'],
# #     }


# # class MoEFFNTimeCostModel(LogPrint):
# #     def __init__(self,
...
# #         components = {'TrainArgs': train_args, 'ProfileModelArgs': profile_model_args, 'ProfileHardwareArgs': profile_hardware_args, 'UtilsArgs': utils_args, 'VersionOptionArgs': version_option_args}
